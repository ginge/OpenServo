// Servo-base.cpp : Implementation of CSuperServo
...
STDMETHODIMP CSuperServo::Detect()
{
...
STDMETHODIMP CSuperServo::get_typeName(BSTR* pVal)
{
...
STDMETHODIMP CSuperServo::get_address(USHORT* pVal)
{
	*pVal = m_address;
	return S_OK;
}

STDMETHODIMP CSuperServo::get_position(LONG* pVal)
{
	return get_currentPosition(pVal);
}

STDMETHODIMP CSuperServo::put_position(LONG newVal)
{
	return put_targetPosition(newVal);
}

STDMETHODIMP CSuperServo::get_targetPosition(LONG* pVal)
{
	return ReadRegister( 0x60, 1, pVal);
}

STDMETHODIMP CSuperServo::put_targetPosition(LONG newVal)
{
	if(newVal>0xff)
		return E_FAIL;
	return ExecFunction(0x14, 1, newVal);
}

STDMETHODIMP CSuperServo::get_currentPosition(LONG* pVal)
{
	return ReadRegister( 0x61, 1, pVal);
}

STDMETHODIMP CSuperServo::get_current(LONG* pVal)
{
	return ReadRegister( 0x63, 1, pVal);
}

STDMETHODIMP CSuperServo::get_speed(LONG* pVal)
{
	return ReadRegister( 0x62, 1, pVal);
}

STDMETHODIMP CSuperServo::put_speed(LONG newVal)
{
	if(newVal>0xff)
		return E_FAIL;
...
STDMETHODIMP CSuperServo::ScanRegisters(IRegisterSet* registerSet)
{
	LONG count;
	HRESULT hr;
...
HRESULT CSuperServo::ReadRegister(BYTE address, BYTE length, LONG* pval)
{
...
HRESULT CSuperServo::WriteRegister(BYTE address, BYTE length, LONG pval)
{
	if(length>4) return 0;
...
HRESULT CSuperServo::ExecFunction(BYTE function, BYTE length, LONG pval)
{
	BYTE maddr = function;
	return m_pcontroller->Write( m_address, &function, 1, (LPBYTE)&pval, length);
}

STDMETHODIMP CSuperServo::get_registers(IRegisterSet** pVal)
{
...
STDMETHODIMP CSuperServo::get_name(BSTR* pVal)
{
...
STDMETHODIMP CSuperServo::put_name(BSTR newVal)
{
	m_name = newVal;
	return S_OK;
}

STDMETHODIMP CSuperServo::get_enabled(VARIANT_BOOL* pVal)
{
	USHORT maddr = 0x0164;
	BYTE data;
...
STDMETHODIMP CSuperServo::put_enabled(VARIANT_BOOL newVal)
{
